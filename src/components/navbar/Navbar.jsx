...
import Image1 from "../../assets/profile.avif";
    ...
    <div className="bg-white sticky top-0 z-50  "  >
      ...
      <header className="relative bg-white">
        ...
        style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
          Get free delivery on orders over 1000Rs
        </p>

        <nav aria-label="Top" className="bg-grey-100 px-4 sm:px-6 lg:px-8 shadow-xl "
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/order'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-3xl  font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>E-MALL</h1>
                  </div>
                </Link>
              </div>

              <div className=" ml-auto flex items-center">
                <div className="invisible lg:visible lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">

                  <Link to={'/allproducts'} className="text-sm font-medium text-gray-900 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    All Products
                  </Link>
                  <Link to={'/order'} className="text-sm font-medium text-gray-900 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Order
                  </Link>
                  <Link to={'/dashboard'} className="text-sm font-medium text-gray-900 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Admin
                  </Link>


                  <a href='#' className="text-sm font-medium text-gray-900 cursor-pointer  " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Logout
                  </a>
                </div>

                <div className="invisible lg:visible lg:ml-8 lg:flex">
